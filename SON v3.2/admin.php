...
<html lang="en">
    ...
    <?php
        ...
        if (isset($_POST['refresh'])) {
            ...
            unset($_SESSION['search_fact_name']);
            echo "<script type='text/javascript'>
                $(document).ready(function(){
                ...
                <ul class="nav navbar-nav mx-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-2 " aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="#">Reset Faculty's Password</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
    	...
    	<div class="row">
			<div class="col-md-12">
				<div class="panel panel-primary">
					...
					<table class="table table-hover text-center table-responsive" id="dev-table">
						<thead>
							<tr>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td><form action='scripts/download.php' class='d-inline' method='post' name='download' id='download-link'>
                                        ...
                                        <button class='btn btn-dark my-2' type='submit' name='gosearch'><i class='fas fa-upload'></i></button>
                                        <form class='d-inline' method='get' action='cv/pdf/cherdalilis@yahoo.com.pdf'>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <span id="h1-sub">
                        ...
                        <button class='btn btn-dark' type='submit' name='gosearch'><i class='fas fa-upload'></i></button>
                        <form class='d-inline' method='get' action='cv/pdf/cherdalilis@yahoo.com.pdf'>
                            <button class='btn btn-dark my-2' type='submit'><i class='fas fa-eye'></i></button>
                        </form>
                    </span>
